...
#PBS -q long
#PBS -o aste_daily_phibot.out
#PBS -e aste_daily_phibot.err
...
iter=0
forwadj="_ad_dailybp_tamch_10x73x73"
forwadj="_ad_dailybp_noprof_tamch_10x73x73"

whichexp="_phibot"
jobfile=script_daily_coldstarttrue.bash
...
inputdir=$basedir/input${whichexp}_daily
rundir=run${mitgcm_version}${whichexp}_daily_coldstarttrue_lsrerror_subgyre_misfit
rundir=run${mitgcm_version}${whichexp}_daily_fullNR_coldstarttrue_subgyre_misfit
workdir_root=$scratchdir/osses/${rundir}

optimdir=${basedir}/OPTIM_daily_coldstarttrue
costfactors=(0.95 0.95 0.98 0.98 0.98 0.98 0.98 0.98 0.98 0.98 0.98 0.98 0.98 0.98 0.98 0.98 0.98 0.98 0.98 0.98 0.98 0.98 0.98)
#costfactors=(0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95 0.95)
iter=0
iterstart=0
...
#    fi
    ...
    aste_bp_fname="SMART_bp_detide_detrend_day_530x1350x270_25_subgyre"
...
#    cp data.ctrl_uvmult0 data.ctrl
