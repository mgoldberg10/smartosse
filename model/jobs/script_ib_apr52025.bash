...
rundir=run${mitgcm_version}${whichexp}_ib_freq_apr052025
...
for ctrl_freq in "${ctrl_freqs[@]}"; do
    ...
    ctrl_freq_seconds=$((ctrl_freq * 86400))
    ctrl_freq_dir=${scratchdir}/run_template/input_ADXX_iter0062_20122024_4888/ib_freqs_apr052026/${ctrl_freq}day_ctrl
    ...
    while true; do
        ...
        aste_bp_fname="SMART_bp_detide16constituents_detrend_201201_31x1350x270_142sensors_fullnatl_ctrlfreq_${ctrl_freq}"

        ln -s ${scratchdir}/run_template//input_ecco/smart_phibot/one_month_daily_bp_experiments/ib_staggered/$aste_bp_fname.bin ./$aste_bp_fname
