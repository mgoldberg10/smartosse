...
rundir=run${mitgcm_version}${whichexp}_partialcables_jrastd_daytoday
...
regions=("fullnatl" "labsea" "newfoundland" "northsea" "subgyre")
nss=(142 64 27 41 25)
#regions=("fullnatl")
#nss=(142)
...
while true; do
    ...
    aste_bp_fname="SMART_bp_detide16constituents_detrend_${mo_str}_${nday}x1350x270_${ns}sensors_${region_str}"
...
#########    cp data.ctrl_dailyxx_multgen_jraspreadapressure data.ctrl
    cp data.ctrl_dailyxx_multgen_jrastd_daytoday data.ctrl
