...
#PBS -q long
#PBS -o aste_phibot_uv0.out
#PBS -e aste_phibot_uv0.err
...
rundir=run${mitgcm_version}${whichexp}_uv0_fullNR_subgyre_${ext3}_${nprocs}_it${ext2}_pk${pickupts1}
workdir_root=$scratchdir/osses/${rundir}

optimdir=${basedir}/OPTIM
