...
##PBS -q devel
#PBS -q long
#PBS -o smartosse_year.out
#PBS -e smartosse_year.err
...
rundir=run${mitgcm_version}${whichexp}_natl_1month_alldailyxx_gracellc4320_sc_spread
...
#    mpiexec -n ${nprocs} ./mitgcmuv${forwadj}
    ...
    echo "=================================================="
    echo "MITGCM EXIT STATUS: $rc"
    echo "=================================================="
    
    if [[ $rc -ne 0 ]]; then
        echo "MITGCM FAILED — NOT restarting automatically."
        exit $rc
    fi
