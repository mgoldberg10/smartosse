...
#undef EXF_ZERO_BOUND_AQH
#define EXF_ZERO_BOUND_PRECIP
catn modified Ou code to only limit neg rain above 50N
#define EXF_ZERO_BOUND_PRECIP_50N
#undef EXF_ZERO_BOUND_SWDOWN
#undef NO_NIGHTTIME_CTRL_ADJ_TO_SWDOWN
#undef EXF_ZERO_BOUND_LWDOWN
#undef EXF_ZERO_BOUND_RUNOFF
#undef EXF_ZERO_BOUND_WSPEED
#undef TURNOFF_CAPPING_PRECIP_BY_SNOWPRECIP
